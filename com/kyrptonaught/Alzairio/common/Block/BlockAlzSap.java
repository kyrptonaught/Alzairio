...
if ((l & 8) == Blocks.alzadirt.blockID)
{
...
object = new WorldGenAlzTree(true, 10 + par5Random.nextInt(20), 3, 3, false);
flag = true;
break;
}
}
...
i1 = 0;
/** Change this to your WorldGenNAMETree **/
object = new WorldGenAlzTree(true, 4 + par5Random.nextInt(7), 3, 3, false);
}
}
else
{
/** Change this to your WorldGenNAMETree **/
object = new WorldGenAlzTree(true); // Changed //
...
return par1 == Blocks.alzadirt.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID;
}
@Override 
