...
public class WorldProviderAlzairio extends WorldProvider
{
	...
	{
		this.worldChunkMgr = new WorldChunkManagerHell(Alzairio.AlzairioBiome, this.dimensionId, this.dimensionId);
		this.dimensionId = Alzairio.DimID;
		this.hasNoSky = false;
	}
	public IChunkProvider createChunkGenerator()
	{
		return new ChunkProviderAlzairio(this.worldObj, this.worldObj.getSeed(), false);
	}
	@SideOnly(Side.CLIENT)
	public IRenderHandler getSkyRenderer()
	{
		return new AlzSkyRenderer();
	}
	...
	{
		if ((this instanceof WorldProviderAlzairio))
		{
			return "Entering Alzairio Dimension";
		}
		return null;
	}
	@SideOnly(Side.CLIENT)
