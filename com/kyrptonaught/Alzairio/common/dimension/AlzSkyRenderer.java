...
public class AlzSkyRenderer extends IRenderHandler
{
private int starGLCallList;
private int glSkyList;
private int glSkyList2;
private static final ResourceLocation sun = new ResourceLocation(Alzairio.modid, "textures/environment/sun.png");
private static final ResourceLocation moon = new ResourceLocation(Alzairio.modid, "textures/environment/moon_phases.png");
public AlzSkyRenderer()
{
...
public void render(float partialTicks, WorldClient world, Minecraft mc) {
  ...
  mc.renderEngine.bindTexture(sun); // Sun texture + texture path
  ...
  mc.renderEngine.bindTexture(moon); // Moon texture + texture path
