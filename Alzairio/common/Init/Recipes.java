...
public class Recipes {
	...
	//Blocks
		 ...
		 GameRegistry.addRecipe(new ItemStack(Alzairio.common.Init.Blocks.Reducer,1), new Object[] { "#$#","###","#$#",Character.valueOf('#'),Block.blockSteel ,Character.valueOf('$'),Item.redstone});
   ...
   //Items 
		 GameRegistry.addRecipe(new ItemStack(Alzairio.common.Init.Items.checker,1), new Object[]{"^^*","^$^","$^^",Character.valueOf('*'),Item.redstone,Character.valueOf('$'),Item.stick});
         GameRegistry.addRecipe(new ItemStack(Alzairio.common.Init.Items.Iscaffold,1), new Object []{"%%%","###","%%%", Character.valueOf('%'),Block.planks,Character.valueOf('#'),Block.ladder});
