...
public class WorldGenHandler implements IWorldGenerator { //Implements IWorldGenerator
	...
	case 0:generateSurface(random,chunkX*16,chunkZ*16,world); //This makes it gen overworld (the *16 is important)
	}
	}
	...
	new WorldGenMinable(Alzairio.alzairianOre.blockID,i,random.nextInt(9)).generate(w, random, posX, posY, posZ); //The gen call
	}
	}
	}
	}
