...
import Alzairio.common.dimension.AlzTeleporter;
...
public class BlockTeleporter extends BlockBreakable
{
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		...
		/*if(par5Entity.dimension != Alzairio.DimID)
		{
			par5Entity.travelToDimension(Alzairio.DimID);
			//thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Alzairio.DimID);
		}
		else {
