...
public class WorldGenAlzTree extends WorldGenerator implements IWorldGenerator
{
...
public WorldGenAlzTree(boolean par1)
{
this(par1, 8, 0, 0, false);
}
public WorldGenAlzTree(boolean par1, int par2, int par3, int par4, boolean par5)
{
super(par1);
...
/** Custom grass block **/
Block block = Blocks.alzadirt;
if (k1 != 0 && !block.isLeaves(par1World, l1, i1, j1)

/** Custom grass block **/
&& k1 !=Blocks.alzadirt.blockID
...
/** Custom grass block **/
Block soil =Blocks.alzadirt;

/** Custom Sapling block **/
boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockAlzSap)Blocks.AlzSap));
...
{
/** Custom leaf block **/
this.setBlockAndMetadata(par1World, j2, j1, l2, Blocks.AlzLeaf.blockID, this.metaLeaves);
}
}
}
}
...
{
/** Custom Log block **/
this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, Blocks.AlzLog.blockID, this.metaWood);
}
}
...
(new WorldGenAlzTree(false, 9, 0, 0, false)).generate(world, random, xCoord, yCoord, zCoord);
}
}
}
