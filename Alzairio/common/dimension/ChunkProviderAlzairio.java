	...
	*/
	...
	for (int k1 = 0; k1 < b1; ++k1)
	{
	         ...
	         if ((d16 += d15) > 0.0D)
	         {
	                 ...
	                 par3ArrayOfByte[j2 += short1] = (byte)Blocks.alzastone.blockID;//
	         }
	         else if (k1 * 8 + l1 < b2)
	         {
	                 par3ArrayOfByte[j2 += short1] = (byte)Blocks.Water2.blockID;
	         }
	         else
	         {
	...
	for (int var16 = 127; var16 >= 0; var16--)
	{
	         ...
	         /** Main filler block fill's all the underground, replaces block stone **/
	         else if (var18 != Blocks.alzastone.blockID)
	         {
	         if (var13 == -1)
	         {
	         if (var12 == 0)
	         {
	                 ...
	                 var15 = (byte)Blocks.alzadirt.blockID;//
	         }
	...
	new WorldGenLakes(Blocks.Water2.blockID).generate(this.worldObj, this.rand, var12, var13, var14);
	}
