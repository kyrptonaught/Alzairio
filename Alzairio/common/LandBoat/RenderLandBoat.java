...
public void renderBoat(EntityLandBoat par1EntityLandBoat, double par2, double par4, double par6, float par8, float par9)
{
         ...
         float var10 = par1EntityLandBoat.getTimeSinceHit() - par9;
         float var11 = par1EntityLandBoat.getDamageTaken() - par9;
         if (var11 < 0.0F)
         {
                 var11 = 0.0F;
         }
         if (var10 > 0.0F)
         {
                 GL11.glRotatef(MathHelper.sin(var10) * var10 * var11 / 10.0F * par1EntityLandBoat.getForwardDirection(), 1.0F, 0.0F, 0.0F);
         }
