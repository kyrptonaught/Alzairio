...
public class EntityLandBoat extends Entity
{
...
public EntityLandBoat(World par1World)
{
         ...
         this.texture = CommonProxyAlzairio.LandBoat_png;
                 ...
                 if (!this.worldObj.isRemote)
                 {
                         ...
                         if (var16 != null && !var16.isEmpty())
                         {
                                 for (var27 = 0; var27 < var16.size(); ++var27)
                                 {
                                         ...
                                         if (var18 != this.riddenByEntity && var18.canBePushed() && var18 instanceof EntityLandBoat)
                                         {
