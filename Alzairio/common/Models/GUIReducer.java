...
public class GUIReducer extends GuiContainer
{
...
public GUIReducer(IInventory par1IInventory, IInventory par2IInventory)
{
         super(new ConatainerReducer(par1IInventory, par2IInventory));
...
{
         int var4 = this.mc.renderEngine.getTexture(CommonProxyAlzairio.container);
