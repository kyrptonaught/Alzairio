...
public class ConatainerReducer extends Container{

	private IInventory lowerChestInventory;
	private int numRows;
	public ConatainerReducer(IInventory par1IInventory, IInventory par2IInventory)
	{
	         ...
	         int var4;
	         int var5;
	        // this.addSlotToContainer(new Slot(par2IInventory, 5,5,5));
