...
public class ModelLightningWand extends ModelBase
{
	//fields
	ModelRenderer StaffStick;
	...
	public ModelLightningWand()
	{
		textureWidth = 64;
		textureHeight = 32;

		StaffStick = new ModelRenderer(this, 0, 0);
		StaffStick.addBox(0F, 0F, 0F, 1, 10, 1);
		StaffStick.setRotationPoint(0F, 0F, 0F);
		StaffStick.setTextureSize(64, 32);
		StaffStick.mirror = true;
		setRotation(StaffStick, 0F, 0F, 0F);
		...
		Shape4.setRotationPoint(-1F, -4F, 1F);
		...
		Shape6.setRotationPoint(1F, -4F, 1F);
